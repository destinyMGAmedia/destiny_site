...
// PROGRAMMES
export const programmes = [
  { title: "Worship & Praise", description: "Experience powerful worship that ushers in God's presence and transforms hearts", icon: "FaMusic", schedule: ["Sunday Services", "Special Events", "Choir Practice"] },
  { title: "Bible Study", description: "Deep diving into God's Word to build strong foundations of faith", icon: "FaBook", schedule: ["Wednesday Bible Study", "Small Groups", "Online Study"] },
  { title: "Youth Ministry", description: "Empowering the next generation to walk in their purpose and fulfill their destiny", icon: "FaUsers", schedule: ["Youth Service", "Youth Camps", "Mentorship Programs"] },
  { title: "Prayer & Intercession", description: "Corporate prayer sessions that bring breakthrough and move the hand of God", icon: "FaMessageCircle", schedule: ["Early Morning Prayers", "Prayer Vigils", "Prayer Chain"] },
  { title: "Community Outreach", description: "Touching lives in our community through acts of love and service", icon: "LuHandHelping", schedule: ["Food Distribution", "Hospital Visits", "Community Events"] },
  { title: "Discipleship", description: "Mentoring and equipping believers to grow in Christ", icon: "LuChurch", schedule: ["New Believers Class", "Leadership Training", "Mentoring"] },
  { title: "Children's Ministry", description: "Nurturing young hearts to know and love Jesus", icon: "TbMoodKid", schedule: ["Sunday School", "Vacation Bible School", "Children's Church"] },
  { title: "Women's Ministry", description: "Empowering women to discover their identity in Christ and fulfill their purpose", icon: "MdWoman", schedule: ["Women's Fellowship", "Bible Study", "Conferences"] },
  { title: "Men's Ministry", description: "Raising godly men who lead with integrity and strength", icon: "MdMan", schedule: ["Men's Fellowship", "Accountability Groups", "Retreats"] },
];

// WEEKLY SCHEDULE
export const weeklySchedule = [
  { title: "Sunday Worship Service", date: "Every Sunday", time: "9:00 AM - 12:00 PM", location: "Main Sanctuary", description: "Join us for powerful worship, life-changing messages, and fellowship" },
  { title: "Midweek Bible Study", date: "Every Wednesday", time: "6:00 PM - 8:00 PM", location: "Fellowship Hall", description: "Deep dive into God's Word and grow in your understanding" },
  { title: "Prayer Vigil", date: "First Friday of Every Month", time: "10:00 PM - 2:00 AM", location: "Prayer Room", description: "Corporate prayer and intercession for breakthrough" },
  { title: "Youth Night", date: "Every Saturday", time: "5:00 PM - 7:00 PM", location: "Youth Center", description: "Fun, fellowship, and faith-building activities for young people" },
];

// SPECIAL EVENTS
export const specialEvents = [
  { title: "Annual Conference", description: "Three days of powerful teaching, worship, and impartation", icon: "TbBuildingCircus" },
  { title: "Community Outreach", description: "Reaching out to our community with the love of Christ", icon: "LuHandHelping" },
  { title: "Family Fun Day", description: "A day of fun activities and fellowship for the whole family", icon: "TbConfetti" },
  { title: "Leadership Summit", description: "Equipping and empowering leaders for effective ministry", icon: "TbCalendarStar" },
];
