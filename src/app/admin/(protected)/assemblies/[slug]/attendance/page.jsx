...
export default async function AssemblyAttendancePage({ params }) {
  ...
  const [headcountStats, arkStats] = await Promise.all([
      ...
      <div className="space-y-12">
        <section>
          <div className="mb-6">
            ...
            <p className="text-sm text-gray-500">Record attendance, offering, and other service details for main assembly and Ark Center services.</p>
          </div>
          ...
          <div className="bg-purple-50 p-6 rounded-2xl border border-purple-100">
            ...
            <div className="flex gap-4">
               <div className="px-4 py-2 bg-white rounded-lg shadow-sm border border-purple-100 text-xs font-bold">
                 {assembly._count.arkCenters} Centers Active
               </div>
            </div>
          </div>
        </section>
